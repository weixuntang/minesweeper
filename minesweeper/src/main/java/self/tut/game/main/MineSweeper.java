...
public class MineSweeper {
   ...
   * 
   * First array to contains number and bomb. Second array to contains data to display on the
   * screen.
   * 
   * Both arrays will be generated randomly by the system.
   * 
   * At each turn players will be prompted to input x, y value. If there is a bomb in the location.
   * The game will end otherwise. It will reveal the neighbouring cell.
   * 
   * 
   * Class Objective : - To contain the rules and method that will dictate the game.
   */
